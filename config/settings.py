...
INSTALLED_APPS = [
    ...
    'rest_framework','rest_framework_simplejwt.token_blacklist','django_filters','drf_spectacular','django_celery_beat',
    'users','courses',
]
...
SPECTACULAR_SETTINGS = {'TITLE': 'LMS API','DESCRIPTION':'LMS API','VERSION':'1.0.0'}
# Celery/Redis
